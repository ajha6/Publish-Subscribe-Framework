...
import broker.SynchronousOrderedDispatchBroker2;
import item.Reviews;
...
public class TestAppSync {
	...
	public static void main(String[] args) {
		...
		System.out.println("project2 Sync Broker");
		...
		//Thread helperThread1 = new Thread(new AsyncOrderedBrokerHelper());
		//Thread helperThread2 = new Thread(new AsyncOrderedBrokerHelper());
