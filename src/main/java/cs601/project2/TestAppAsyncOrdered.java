 ...
 */
public class TestAppAsyncOrdered {
	...
	public static void main(String[] args) {
		...
		System.out.println("Project2 - Asynchronous ordered Broker Test App");
		//reading configuration file content into Project2Init object
		Project2Init init = Project2InitReader.project2InitjsonReader();

		//initializing logger 
		Project2Logger.initialize("Asynchronous ordered Broker Test App", init.getLoggerFile());
		...
		AsyncOrderedBroker<Reviews> broker = AsyncOrderedBroker.getInstance();
